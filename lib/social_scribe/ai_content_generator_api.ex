defmodule SocialScribe.AIContentGeneratorApi do
  ...
  @callback generate_contact_chat_response(String.t()) :: {:ok, String.t()} | {:error, any()}
  ...
  def generate_contact_chat_response(prompt) do
    impl().generate_contact_chat_response(prompt)
  end
